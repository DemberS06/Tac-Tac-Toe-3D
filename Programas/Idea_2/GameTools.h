...
/** @brief Alias para el resultado del análisis de una semilla.
 * first: Mapa completo de movimientos óptimos (MoveMap_t).
 * second: Jugador ganador para el estado inicial (int: 1, 2, o 0). */
using SeedResult_t = std::pair<MoveMap_t, int>;
