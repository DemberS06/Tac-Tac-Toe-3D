...
private: // --- MIEMBROS PRIVADOS ---
    ...
    long double Learning_Rate = 0.1;    // Tasa de aprendizaje
    const int MiniBatchSize = 1;       // Tamaño del mini-lote (marcado como const, podría ser inicializado de otra forma si es necesario)
